...
| -------------- | ------- | ------------ |----------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|  |  |  |  |
| 0x1F206EB9d5B428F86FeFd800f7561844773596Be | https://github.com/MorpheusAIs/Lite-Client/issues/64 | https://github.com/MorpheusAIs/Lite-Client/pull/63 | 8000 | Improve Morpheus client developer experience by removing `yarn` for one less necessary global install and update README for more generalized instructions. |
