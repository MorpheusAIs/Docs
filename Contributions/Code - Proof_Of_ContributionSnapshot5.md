...
---|---|---|---|---|---|---
 ...
 5 | 8 |0x80AC5d6B29EC148cb1f71a18C2A4F0A0c7DEddF0 | mor-codes | Fix the broken snapshot 1-4 tables and publish normalized CSV files for the data analyst to analyze the weight data easily | https://github.com/MorpheusAIs/Docs/pull/269, https://github.com/mor-codes/Morpheus-Code-Contribution-CSV | 10000 | 
 5 | 8 |0x80AC5d6B29EC148cb1f71a18C2A4F0A0c7DEddF0 | mor-codes | Cross-check the original version of the snapshot table to hunt for missing and additional weight records, detecting an additional 2,083,339 weights added to the new snapshot files | https://github.com/MorpheusAIs/Docs/pull/285, https://colab.research.google.com/drive/1OJrzOtF8Jg8OLee03NJH63pj_xowS7M6?usp=sharing, https://docs.google.com/spreadsheets/d/14VeA4fOqBGIjFynrLYeOhVdKaFGdb1Frtp2ltOIuNm4/edit?usp=sharing | 10000 | 
