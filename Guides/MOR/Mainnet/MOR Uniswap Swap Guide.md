# MOR Uniswap Swap Guide (in work)
...
Go to the Uniswap web app [https://app.uniswap.org](https://app.uniswap.org/pools?chain=arbitrum) and choose Arbitrum chain in the top right corner of the screen.
...
`0x84efb4db4265966742fa3671aa841a8f21dd2d4f` for **MOR** 
